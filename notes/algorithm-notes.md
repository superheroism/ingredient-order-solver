...
With only 720 possible sequences (10 choose 3 × permutations), the solver converges rapidly in simulation and interactive play.  We expect solutions within the allotted number of guesses!
